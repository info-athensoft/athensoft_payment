	...
	<div class="row">
		...
		<div class="col-lg-8">
			...
			<div class="panel panel-primary">
			  ...
			  <div class="panel-heading"><b>Test shipping details</b></div>
			  
				<!-- Table -->
			 	PAYMENTREQUEST_0_TAXAMT = ${shipping_details_hashmap.PAYMENTREQUEST_0_TAXAMT}
			</div>
			...
			<div id="post_payment">
				<button class="btn btn-success btn-lg" onclick="returnHome();" >Return home</button>
			</div>
